      ...
      <Layout>
        <Container>
          <Box border={2} className={classes.root}>
            ...
            <Box className={classes.thankContent}>
              <Box style={{display: 'flex', alignItems: 'center', marginBottom: 20}}>
                ...
                <Typography style={{marginLeft: 10}} variant="h4">Thank you for taking this test!</Typography>
              </Box>
              <Box style={{fontWeight: 'lighter'}}>
                The recruiter/lecturer will get back to you shortly with the results.
              </Box>
              <Box style={{fontWeight: 'lighter'}}>
          ...
          <Box className={classes.buttonBox}>
            <Button size="large" color="primary" variant="contained" href="/" >Back to Home!</Button>
          </Box>
        </Container>
