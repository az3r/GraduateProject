...
export default function MultipleChoiceForm({onFormSubmit, propQuestion})
{
    ...
    function validate(){
        ...
        {
            setMessage({...message, question: true, message: 'Problem question must not be empty'});
            return false;
        }
        if(question.score === undefined)
        {
            setMessage({...message, score: true, message: 'Problem score must not be empty'});
            return false;
        }
        if(question.a === undefined || question.a === '')
        {
            setMessage({...message, a: true, message: 'Answer A content must not be empty'});
            return false;
        }
        if(question.b === undefined || question.b === '')
        {
            setMessage({...message, b: true, message: 'Answer B content must not be empty'});
            return false;
        }
        if(question.c === undefined || question.c === '')
        {
            setMessage({...message, c: true, message: 'Answer C content must not be empty'});
            return false;
        }
        if(question.d === undefined || question.d === '')
        {
            setMessage({...message, d: true, message: 'Answer D content must not be empty'});
            return false;
        }
        if(question.correct === undefined || question.correct === '')
        {
            setMessage({...message, correct: true, message: 'Correct answer must be chosen'});
            return false;
        }
        return true;
